...
#
# Generated by Vivado on Thu Dec 08 21:56:50 -0500 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../eggtimer_Taweef_saad_final.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../eggtimer_Taweef_saad_final.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../eggtimer_Taweef_saad_final.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
